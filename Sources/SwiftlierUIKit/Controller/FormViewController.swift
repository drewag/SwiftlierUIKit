...
private class SimpleFieldTableViewCell: UITableViewCell {
    ...
    func resetConstraints() {
        ...
        if #available(iOS 9.0, *) {
            leftConstraint = self.contentView.readableContentGuide.leftAnchor.constraint(equalTo: self.nameLabel.leftAnchor)
            leftConstraint.isActive = true
        } else {
            leftConstraint = self.contentView.constrain(.left, of: self.nameLabel, plus: -12)
        }
        self.customConstraints += [
...
private class BoolFieldTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        if #available(iOS 9.0, *) {
            ...
            self.contentView.constrain(.left, of: self.nameLabel, plus: -12)
        }
        ...
        if #available(iOS 9.0, *) {
            ...
            self.contentView.constrain(.right, of: self.messageLabel, plus: -12)
        }
    }
...
private class TextViewFieldTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        if #available(iOS 9.0, *) {
            ...
            self.contentView.constrain(.right, of: self.textView, plus: 12)
        }
...
private class SegmentedControlTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        if #available(iOS 9.0, *) {
            ...
            self.contentView.constrain(.right, of: self.segmentedControl, plus: 12)
        }
    }
...
private class SliderTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        if #available(iOS 9.0, *) {
            ...
            self.constrain(.left, of: self.nameLabel, plus: -12)
        }
        ...
        if #available(iOS 9.0, *) {
            ...
            self.contentView.constrain(.right, of: self.valueLabel, plus: 12)
        }
    }
